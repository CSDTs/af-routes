														...
														<div className="flex items-center gap-4">
															<label>
																...
																<input
																	...
																	className="items-center  w-full h-12 px-4 space-x-3 text-left bg-slate-100 rounded-lg shadow-sm sm:flex ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 placeholder:placeholder:text-slate-400 text-slate-800  text-slate-800 "
																/>
															</label>
