...
const TwoColumn = (props: LayoutProps) => {
	...
	useEffect(() => {
		if (locations.length > 0 && locations[0]?.coordinates && locations[1]?.coordinates) {
				...
				<div className=" w-10/12 mx-auto my-3 flex justify-between">
					...
					<div>
						<button
							...
							className="bg-slate-700 font-semibold text-base text-white px-4 py-2 disabled:bg-slate-400"
