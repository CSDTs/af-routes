		...
		<main className="flex flex-col h-full lg:h-screen lg:flex-row ">
			...
			<section className="flex flex-col justify-between w-full bg-white h-6/12 md:w-full lg:w-5/12 lg:h-full xl:w-4/12 2xl:w-3/12 3xl:w-2/12">
				...
				<Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
					<Tab.List className="flex mx-auto mb-5 space-x-1  border-b-indigo-500/20 border-b-4 w-full py-3">
							...
							<div className="mb-3">
								...
								<div className="relative rounded-md shadow-sm">
									<input
										...
										name="location"
										id="location"
										className="block w-full rounded-md border-0 py-1.5 pl-3.5 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6 bg-slate-100"
